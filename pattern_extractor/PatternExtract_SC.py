...
"""
Here is the method for extracting security patterns of suicide.
"""

# 存储pattern
def store_pattern(data: dict):
    info_json = json.dumps(data)
    with open("../pattern_feature/suicide.json", "a+") as f:
...
if __name__ == "__main__":
    ...
    label = None
    inputFileDir = "../data/dataset/suicide/"
    outputfeatureDir = "../pattern_feature/feature_zeropadding/suicide/"
