...
def store_pattern(data: dict):
    ...
    with open("../pattern_feature/timestamp.json", "a+") as f:
...
def extract_pattern(filepath):
    ...
    ################   pattern 2 是否将timestap赋予给变量，这里没涉及参数问题 #######################
...
if __name__ == "__main__":
    ...
    label = None
    inputFileDir = "../data/dataset/time_manipulation/"
