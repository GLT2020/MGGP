...
class GRU_normal():
    ...
    def train(self,train_loader,epoch):
        ...
        pre_loss = 0.9
        for batch_idx, data in enumerate(train_loader):  # 读取的data:操作码序列， 操作码序列的长度列表， labels
            ...
            if loss < pre_loss:
                ...
                # torch.save(self.model, 'model/pth/gru_D2_address.pth')
                torch.save(self.model, 'model/pth/gru_D2_'+ PER +'.pth')
                pre_loss = loss
